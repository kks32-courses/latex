...
\href{https://kks32-courses.github.io/latex/articles/colour-blindness/}
{https://kks32-courses.github.io/latex/articles/colour-blindness/}
...
\begin{itemize}
\item In Overleaf create a new folder \cmmd{figs} and move your figures in to \cmmd{figs} folder.
...
\begin{itemize}
\item Put your references in a \bftt{.bib} file in `biblatex' database format:
...
\begin{itemize}
\item Use the \texttt{biblatex} package with \cmdbs{textcite}and \cmdbs{autocite}
  for textual and parenthetical citations, respectively.
\item Add references using \cmdbs{printbibliography} at the end, and specify a 
...
\begin{center}
\fbox{\href{\wlnewdocarray{Ex8-Paper/Ex8-Paper.tex\wlmorearray{Ex8-Paper/references.bib}\wlmorearray{Ex8-Paper/figure.pdf}}}
{%
Click to open this exercise in \wllogo{}}}
...
\fbox{\href{https://www.overleaf.com/latex/templates/phd-thesis-template-for-cambridge-university-engineering-department-cued-latex-xelatex-and-lualatex-support-v2-dot-1/kgfqybfnqkdf}{%
